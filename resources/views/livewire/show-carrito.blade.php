<div class="flex flex-col mt-8">
    ...
    <h2 class="font-semibold text-3xl text-gray-700">Carrito</h2>
    @if(count($cartContent))
    <div>
            ...
            <table class="min-w-full">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                        <td class="flex justify-center text-gray-700 font-light md:px-4 py-2 whitespace-nowrap w-auto">
                        ...
                        <td
                            class="text-sm md:text-md text-center text-red-600 font-light md:px-4 py-2 whitespace-nowrap w-auto">
        ...
        <div class="w-full flex justify-between items-center text-2xl text-gray-700 font-semibold mt-10 mr-12">
            ...
            <div>
                <a class="bg-red-600 text-white text-xl font-semibold px-4 py-1 rounded"
