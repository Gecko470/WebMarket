<div class="bg-white text-gray-700 shadow-lg rounded-lg p-6 mt-6 relative mx-2 xl:mx-0">
    <h2 class="text-2xl font-semibold mb-4">Compras realizadas</h2>
    ...
    <div>
        <a class="my-4 p-4 font-semibold hover:bg-gray-200 flex items-center gap-4"
            ...
            <span>
                @switch($order->status)
                @case(0)
                <i class="fas fa-business-time text-gray-600 text-2xl"></i>
                @break
                @case(1)
