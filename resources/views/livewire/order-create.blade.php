<div class="container mx-auto pt-10 pb-56 gap-6 flex">
    <div class="w-2/5 text-gray-700">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                        <td class="flex justify-center text-gray-700 font-light md:px-4 py-2 whitespace-nowrap">
