<div x-data="{ open2:false }" x-on:click.away=" open2=false ">
    ...
    <div :class="{ 'hidden':!open2 , 'absolute':open2 }" class="hidden w-full text-gray-700">
            ...
            <div class="bg-white w-1/4">
                ...
                <ul>
                    ...
                    <li class="navigation-link my-6 cursor-pointer"><a
                            class="px-4 py-2 hover:bg-red-600 hover:text-white"
                            ...
                            <div class="grid grid-cols-4 md:p-4">
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="md:px-4 py-2 cursor-pointer hover:bg-red-600 hover:text-white">
                ...
                <div class="grid grid-cols-4 p-4">
                    <div>
                        ...
                        <ul>
                            ...
                            <li class="px-4 py-2 cursor-pointer hover:bg-red-600 hover:text-white">
        ...
        {{-- Menú Responsive--}}
        <div class="w-full absolute top-0 left-0 md:hidden bg-white">
