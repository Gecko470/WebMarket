<div class="max-w-7xl mx-auto pb-20">
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-3xl text-gray-700">Listado de productos</h2>
            <a class="btn btn-danger" href="{{ route('admin.products.create') }}">Nuevo producto</a>
        </div>
    </x-slot>
                ...
                <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                    ...
                    <td class="text-sm font-light px-6 py-4">
                        <div class="flex items-center gap-4">
                            ...
                            <img class="w-16 h-16 object-cover object-center rounded-full"
