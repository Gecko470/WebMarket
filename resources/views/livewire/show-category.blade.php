    ...
    <div wire:init="load" class="text-gray-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mb-6 mx-auto gap-4">
            ...
            <div class="shadow-lg p-8">
                <a class="mx-2 text-lg text-red-600" href="{{ route('home') }}">
                    <span>Volver</span>
                </a>
                ...
                <div class="w-full mt-8 flex items-center gap-4">
                    <x-jet-dropdown align='left' width="w-52">
                        <x-slot name='trigger'>

                            <button type="button"
                                class="flex items-center justify-between w-52 px-2 py-2 text-xl leading-4 font-semibold transition border">
                                <div>Marcas</div>
                        ...
                        <x-slot name='content'>
                            <x-jet-dropdown-link wire:click="$set('marca', 'todas')"
                                class="capitalize font-semibold text-lg cursor-pointer" selected>
                                Todas
                            </x-jet-dropdown-link>
                            @if($marca == 'todas')
                            @foreach ($products->first()->category->subcategories as $subcategory )
