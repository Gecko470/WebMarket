<div class="my-8">
    ...
    <div wire:init="load" class="text-gray-700">
        @if ($products->count())

        <div class="grid grid-cols-1 md:grid-cols-2 mb-6 mx-auto gap-4">
            <div class="mb-6 md:mb-0 mx-auto">
                <img class="rounded w-full h-auto object-cover object-center"
                    src="{{ Storage::url($products->first()->category->img) }}"
                    alt="{{ $products->first()->category->name }}">
            </div>
            <div class="shadow-lg shadow-gray-700 p-8">
                ...
                <h2 class="font-semibold text-2xl mx-2">Categoría: {{ $products->first()->category->name }}</h2>
                <h2 class="font-semibold text-2xl mt-4 mx-2 mb-2">Sucategorías:</h2>
                <div class="ml-36 mt-4">
                    @foreach ($products->first()->category->subcategories as $subcategory)
                    <div class="font-semibold text-lg hover:text-red-600"><a
                            href="{{ route('showsubcategory', $subcategory->id)}}"><span
                                class="mx-2">{!!$subcategory->icon!!}</span>{{
                            $subcategory->name }}</a>
                    </div>
                    @endforeach
                </div>
                <div class="shadow-lg shadow-gray-700 w-full mt-8">
                    <x-jet-dropdown align='left' width="w-full">
                        <x-slot name='trigger'>
                            <span>
                                <button type="button"
                                    class="flex items-center justify-between w-full px-2 py-2 border border-gray-500 text-xl leading-4 font-semibold transition">
                                    <div>Marcas</div>
        ...
        <div class="flex shadow-lg shadow-gray-700 py-2 px-4 items-center justify-between gap-2 mx-auto mb-12">
            <div>
                <h2 class="font-semibold text-3xl">Productos</h2>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 mt-3 mx-auto mb-16 gap-4">
            ...
            <div class="shadow-lg shadow-gray-700 p-2">
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    <td
                                        class="text-sm capitalize text-gray-900 font-light px-6 py-4 whitespace-nowrap text-center">
                                        {{
                                        $product->name }}</td>
                                    <td
