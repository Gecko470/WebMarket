<nav x-data="{ open: false }" class="bg-white shadow-lg container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-3 lg:space-x-8 sm:-my-px sm:ml-4 sm:flex">
                    <x-jet-nav-link href="{{ route('admin.index') }}" :active="request()->routeIs('admin.index')">
                        Productos
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.subcategories') }}"
                        :active="request()->routeIs('admin.subcategories')">
                        Subcategorías/Marcas
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.provincias') }}"
                        :active="request()->routeIs('admin.provincias')">
                        Provincias/Ciudades
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('admin.subcategories') }}"
                :active="request()->routeIs('admin.subcategories')">
                Subcategorías/Marcas
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('admin.provincias') }}"
                :active="request()->routeIs('admin.provincias')">
                Provincias/Ciudades
            </x-jet-responsive-nav-link>
